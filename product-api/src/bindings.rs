        ...
        pub mod api {
            ...
            pub fn get_item_types() -> _rt::Vec<ItemTypeModel> {
                unsafe {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "coffeeshop:product/api")]
                    extern "C" {
...
es\x01\x07\x03\x01\x16coffeeshop:product/api\x05\0\x04\x01\x17coffeeshop:product\
/host\x04\0\x0b\x0a\x01\0\x04host\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\
