    ...
    pub mod example {
        pub mod coffeeshop {
            ...
            pub mod product_api {
                ...
                macro_rules! __export_example_coffeeshop_product_api_cabi{
      ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

        #[export_name = "example:coffeeshop/product-api#get-item-types"]
        unsafe extern "C" fn export_get_item_types() -> *mut u8 {
          $($path_to_types)*::_export_get_item_types_cabi::<$ty>()
        }
        #[export_name = "cabi_post_example:coffeeshop/product-api#get-item-types"]
        unsafe extern "C" fn _post_return_get_item_types(arg0: *mut u8,) {
          $($path_to_types)*::__post_return_get_item_types::<$ty>(arg0)
        }
        #[export_name = "example:coffeeshop/product-api#get-item-by-types"]
        ...
        #[export_name = "cabi_post_example:coffeeshop/product-api#get-item-by-types"]
        unsafe extern "C" fn _post_return_get_item_by_types(arg0: *mut u8,) {
          $($path_to_types)*::__post_return_get_item_by_types::<$ty>(arg0)
                ...
                #[doc(hidden)]
                pub(crate) use __export_example_coffeeshop_product_api_cabi;
                #[repr(align(4))]
...
macro_rules! __export_product_core_impl {
  ($ty:ident) => (self::export!($ty with_types_in self););
  ($ty:ident with_types_in $($path_to_types_root:tt)*) => (
  $($path_to_types_root)*::exports::example::coffeeshop::product_api::__export_example_coffeeshop_product_api_cabi!($ty with_types_in $($path_to_types_root)*::exports::example::coffeeshop::product_api);
  )
}
#[doc(inline)]
pub(crate) use __export_product_core_impl as export;

#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.21.0:product-core:encoded world"]
#[doc(hidden)]
...
es\x01\x07\x04\x01\x1eexample:coffeeshop/product-api\x05\0\x04\x01\x1fexample:co\
ffeeshop/product-core\x04\0\x0b\x12\x01\0\x0cproduct-core\x03\0\0\0G\x09producer\
