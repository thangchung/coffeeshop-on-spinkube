    ...
    pub mod coffeeshop {
        pub mod counter {
            ...
            pub mod api {
                ...
                pub type Id = super::super::super::super::coffeeshop::counter::shared::Id;
                pub type CommandType =
                    super::super::super::super::coffeeshop::counter::shared::CommandType;
                pub type OrderSource =
                    super::super::super::super::coffeeshop::counter::shared::OrderSource;
                pub type Location =
                    super::super::super::super::coffeeshop::counter::shared::Location;
                pub type CommandItem =
                    super::super::super::super::coffeeshop::counter::shared::CommandItem;
                pub type OrderDto =
                    super::super::super::super::coffeeshop::counter::shared::OrderDto;
                #[derive(Clone)]
                ...
                pub unsafe fn _export_get_fulfillment_order_cabi<T: Guest>() -> *mut u8 {
                    ...
                    for (i, e) in vec8.into_iter().enumerate() {
                        ...
                        {
                            let super::super::super::super::coffeeshop::counter::shared::OrderDto {
                                id: id2,
                            ...
                            *base.add(21).cast::<u8>() = (location2.clone() as i32) as u8;
                            ...
                            for (i, e) in vec7.into_iter().enumerate() {
                                ...
                                {
                                    let super::super::super::super::coffeeshop::counter::shared::OrderItemLineDto{ item_line_id:item_line_id5, item_type:item_type5, item_status:item_status5, } = e;
        ...
        command_type: super::super::super::super::coffeeshop::counter::shared::CommandType::_lift(arg2 as u8),
        order_source: super::super::super::super::coffeeshop::counter::shared::OrderSource::_lift(arg3 as u8),
        location: super::super::super::super::coffeeshop::counter::shared::Location::_lift(arg4 as u8),
            ...
            let e = {
              ...
              for i in 0..len3 {
                ...
                let e3 = {
                  ...
                  super::super::super::super::coffeeshop::counter::shared::CommandItem{
                    item_type: super::super::super::super::coffeeshop::counter::shared::ItemType::_lift(l2 as u8),
                  }
                };
                result3.push(e3);
              }
            ...
            let e = {
              ...
              for i in 0..len5 {
                ...
                let e5 = {
                  ...
                  super::super::super::super::coffeeshop::counter::shared::CommandItem{
                    item_type: super::super::super::super::coffeeshop::counter::shared::ItemType::_lift(l4 as u8),
                  }
                };
                result5.push(e5);
              }
...
\x04\0\x0bplace-order\x01\x14\x04\x01\x16coffeeshop:counter/api\x05\x08\x04\x01\x17\
coffeeshop:counter/core\x04\0\x0b\x0a\x01\0\x04core\x03\0\0\0G\x09producers\x01\x0c\
